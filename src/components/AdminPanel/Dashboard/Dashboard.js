                     ...
                     <ul className="nav flex-column">
                        <li className="nav-item">
                           <Link className="link" to={`${url}/addMenu`}>
                              <FontAwesomeIcon className="fa-icon" icon={faThLarge} /> Add Menu
                           </Link>
                        </li>
                        <li className="nav-item">
                           <Link className="link" to={`${url}/manageMenus`}>
                              <FontAwesomeIcon className="fa-icon" icon={faThLarge} /> Manage Menus
                           </Link>
                        </li>
                        <li className="nav-item">
                           <Link className="link" to={`${url}/manageOrders`}>
                              <FontAwesomeIcon className="fa-icon" icon={faThLarge} /> Manage Food Orders
                           </Link>
                        </li>
                        <li className="nav-item">
